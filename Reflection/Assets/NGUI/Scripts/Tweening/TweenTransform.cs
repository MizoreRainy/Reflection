...
public class TweenTransform : UITweener
{
    ...
    static public TweenTransform Begin(GameObject go, float duration, Transform from, Transform to , TweenTransform.Method method)
    {
        TweenTransform comp = UITweener.Begin<TweenTransform>(go, duration, method);
        comp.from = from;
        comp.to = to;
